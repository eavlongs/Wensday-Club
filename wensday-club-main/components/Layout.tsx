...
export default function Layout({ children }: { children: React.ReactNode }) {
    return (
        <div className='max-w-[1500px] w-full lg:w-[90%]'>
            <aside className='w-[--sidebar-width] fixed h-screen bg-gradient-to-b from-sky-300 to-rose-300 flex flex-col justify-around'>
                <div className='flex-center flex-col overflow-hidden'>
                    <Link href='/profile'>
                        <div className='max-w-[220px] w-16 sm:w-24 md:w-28 lg:w-[9rem] desktop:w-48 aspect-square relative'>
                            <Image
            ...
            <div className='ml-[--sidebar-width] min-h-screen pb-5'>
