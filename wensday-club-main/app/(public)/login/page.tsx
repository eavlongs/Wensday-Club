...
export default function Page() {
    ...
    return (
        <>
            ...
            <Link href='#'>
                <button
                    className='text-lg lg:text-xl desktop:text-2xl bg-debian-red text-white-smoke font-medium px-16 md:px-14 py-2 rounded-2xl flex align-center my-4 lg:my-5 desktop:my-7 2xl:my-9'
                    onClick={submit}
                >
