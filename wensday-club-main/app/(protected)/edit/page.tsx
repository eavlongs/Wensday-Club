...
export default function Page(){
    return(
        ...
        <div className="hugecontainer w-[1200px] h-[750px] pt-6 border-gray-700">
            ...
            <div className="block max-w-[1200px] h-[280px] rounded-lg bg-white bg-cover p-6 shadow-lg dark:bg-neutral-700" style={{ backgroundImage: 'url("/sonflower.jpg")' }}>
            ...
            <div className="buttom w-[1200px] h-[230px] pt-6 pl-6 flex space-x-10 ">
                <div className='w-[400px] h-[200px]  pt-2 pl-9 border-2 border-gray-700 rounded-xl '>
                    ...
                    <textarea rows={5} cols={40} name="commentfield" defaultValue={"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. "} 
                ...
                <div className='w-[300px] h-[200px]'>
                    <div className="mt-[159px] ml-[200px]">
                            <button className="w-[100px] shadow bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
                                Save
                            </button>
                    </div>
                </div>
