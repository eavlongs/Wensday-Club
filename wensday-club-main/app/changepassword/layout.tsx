  ...
  return (
    <html lang="en">
      <body className="pb-10">
        ...
        <div className="flex-center flex-col mt-7 desktop:mt-10 border-[1px] shadow-xl border-gray-700 rounded-xl lg:w-2/5 md:w-1/2 sm:w-2/3 max-w-2xl mx-auto h-[520px] bg-white-smoke py-2 lg:py-5 desktop:py-7">
            {children}
        </div>
      </body>
    </html>
