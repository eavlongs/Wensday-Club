...
export default function Signup1of3() {
    ...
    return (
        ...
        <p className={ubuntu.className + " font-bold text-xl lg:text-2xl desktop:text-3xl text-debian-red mb-16"}>Change Password (1/2)</p>
        ...
        <LoginInput
                type='password'
                placeholder="Old Password"
                className='mt-3 lg:mt-5 desktop:mt-7' onChange={function (value: string): void {
                    throw new Error("Function not implemented.");
                } }           
        />
        ...
        <div className="flex justify-between mx-auto w-[19rem] md:w-[20rem] lg:w-[24rem] desktop:w-[30rem] my-4 lg:my-5 desktop:my-7 2xl:my-9">
            ...
            <button className="text-center bg-debian-red text-white-smoke font-bold text-lg lg:text-xl desktop:text-2xl px-10 py-2 rounded-2xl 	ml-[19rem]">Next</button>
        </div>
